...
public class MPaySelection extends X_C_PaySelection implements DocAction, DocOptions {
	...
	private void createChecks() {
		...
		for (MPaySelectionLine paySelectionLine : paySelectionLines) {
			...
			String newBpartnerName = paySelectionLine.get_ValueAsString("bpartnername");
			Boolean new1 = BPartnerName == newBpartnerName;
			Boolean new2 = BPartnerName.equals(newBpartnerName);
			//	Instance new
			if(paySelectionCheck == null
					...
					|| !BPartnerName.equals(paySelectionLine.get_ValueAsString("bpartnername"))
				...
				paySelectionCheck.set_CustomColumn("bpartnername",  paySelectionLine.get_ValueAsString("bpartnername"));
				//	Set current values
				chargeId = paySelectionLine.getC_Charge_ID();
				isPrepayment = paySelectionLine.isPrepayment();
				bankAccountToId = paySelectionLine.getC_BankAccountTo_ID();
				BPartnerName = paySelectionLine.get_ValueAsString("bpartnername");
			} else {
