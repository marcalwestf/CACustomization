 ...
 */
public class ProjectGenSO_2 extends ProjectGenSO_2Abstract
{
	/**Sales Order*/
	...
	private String createOrderLine(MProduct product, BigDecimal Qty, PO entity) {
		...
		// Prices from Project Phase or Task
		BigDecimal priceEntered = (BigDecimal)entity.get_Value("PriceEntered");
		line.setPriceEntered(priceEntered);
		line.setPriceActual(priceEntered);
		line.setPriceList((BigDecimal)entity.get_Value("PriceList"));
		line.setLineNetAmt(Qty.multiply(priceEntered));
