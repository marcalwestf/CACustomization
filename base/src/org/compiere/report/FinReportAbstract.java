...
public abstract class FinReportAbstract extends SvrProcess {
	...
	/**	Parameter Name for DeleteEmptyLines	*/
	public static final String DELETEEMPTYLINES = "DeleteEmptyLines";
	...
	/**	Parameter Value for DeleteEmptyLines	*/
	private boolean isDeleteEmptyLines;
	...
	protected void prepare() {
		...
		isDeleteEmptyLines = getParameterAsBoolean(DELETEEMPTYLINES);
	}
	...
	/**	 Getter Parameter Value for DeleteEmptyLines	*/
	protected boolean isDeleteEmptyLines() {
		return isDeleteEmptyLines;
	}

	/**	 Setter Parameter Value for DeleteEmptyLines	*/
	protected void setDeleteEmptyLines(boolean isDeleteEmptyLines) {
		this.isDeleteEmptyLines = isDeleteEmptyLines;
	}
