 ...
 */
public abstract class SBP_CreateMovementsAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SBP_CreateMovements";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "SBP_CreateMovements";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54297;
