 ...
 */
public abstract class CorrectTaxAmtAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "CorrectTaxAmt";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "CorrectTaxAmt";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 3000274;
