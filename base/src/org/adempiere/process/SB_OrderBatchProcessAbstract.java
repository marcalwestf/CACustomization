 ...
 */
public abstract class SB_OrderBatchProcessAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "C_Order_Process";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "C_Order_Process";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 3000242;
