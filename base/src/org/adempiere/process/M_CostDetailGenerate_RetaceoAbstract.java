 ...
 */
public abstract class M_CostDetailGenerate_RetaceoAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "M_CostDetailGenerate_Retaceo";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "M_CostDetailGenerate_Retaceo";
	/** Process Id 	*/
	private static final int ID_FOR_PROCESS = 54384;
