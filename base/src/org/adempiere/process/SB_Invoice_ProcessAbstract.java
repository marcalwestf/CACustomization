...
/** Generated Process for (SB_Invoice_Process)
 *  @author ADempiere (generated) 
 *  @version Release 3.9.3
 */
public abstract class SB_Invoice_ProcessAbstract extends SvrProcess {
	/** Process Value 	*/
	private static final String VALUE_FOR_PROCESS = "SB_Invoice_Process";
	/** Process Name 	*/
	private static final String NAME_FOR_PROCESS = "SB_Invoice_Process";
	/** Process Id 	*/
